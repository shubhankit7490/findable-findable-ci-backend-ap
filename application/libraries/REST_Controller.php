...
abstract class REST_Controller extends \CI_Controller {
    ...
    public function _remap($object_called, $arguments = [])
    {
	    ...
	    if( $is_valid_request && ! $this->rbac->user_has_permission ) {
		    $is_valid_request = $this->rbac->user_has_permission;
	    }
    ...
    protected function _detect_api_key()
    {
        ...
        $this->rest->role = NULL;
	    $this->rest->active_user_id = NULL;
        $this->rest->active_business_id = NULL;
        ...
        if (($key = isset($this->_args[$api_key_variable]) ? $this->_args[$api_key_variable] : $this->input->server($key_name)))
        {
	        ...
	        isset($row->role) && $this->rest->role = $row->role;
	        isset($row->active_user_id) && $this->rest->active_user_id = $row->active_user_id;
	        isset($row->active_business_id) && $this->rest->active_business_id = $row->active_business_id;
